...
# torch.save(model, 'qnn_seed_classifier_full_endcap.pt')

# Option 2: Save only the model state dictionary (recommended)
torch.save(model.state_dict(), './endcap_result/qnn_seed_classifier_weights_endcap.pt')
...
torch.save(training_info, './endcap_result/qnn_training_info_endcap.pt')
...
plt.savefig("./endcap_result/Training_Test_Loss_endcap.png", dpi=300, bbox_inches='tight')
...
plt.savefig("./endcap_result/ROC_Curve_.png", dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("./endcap_result/Confusion_Matrix_.png", dpi=300, bbox_inches='tight')
...
plt.legend()
plt.savefig("./endcap_result/Output_Score_Distribution_.png", dpi=300, bbox_inches='tight')
...
plt.xlabel("Predicted Label")
plt.tight_layout()
plt.savefig("./endcap_result/Normalized_Confusion_Matrix_.png", dpi=300, bbox_inches='tight')
...
plt.yscale("log")
plt.legend()
plt.savefig("./endcap_result/Test_Score_Distribution_.png", dpi=300, bbox_inches='tight')